...
**ITA**: NeuralVault supporta il protocollo **Model Context Protocol (MCP)**, permettendo a Claude Desktop e Cursor di interrogare la tua memoria locale in modo sicuro e sovrano.
**EN**: NeuralVault supports the **Model Context Protocol (MCP)**, allowing Claude Desktop and Cursor to query your local memory securely and sovereignly.
